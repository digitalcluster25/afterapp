...
export const mockArticles: Article[] = [
  {
    ...
    summary: "Полное руководство по применению системы мониторинга восстановления с формулой расчета и практическими рекомендациями",
...
Помните: это инструмент, а не диктатор. Он должен дополнять, а не заменять профессиональный опыт тренера и интуицию спортсмена.`,
    category: "Восстановление",
    publishedAt: "2024-01-20",
    author: "Спортивный физиолог",
    description: "Научно обоснованная система оценки восстановления спортсменов с формулой расчета и практическими рекомендациями"
  },
  {
    id: 2,
    title: "Индивидуальная настройка системы мониторинга",
    summary: "Персонализация весовых коэффициентов и адаптация системы под индивидуальные особенности спортсмена",
    content: `# Индивидуальная настройка системы мониторинга восстановления
...
- Планирование ротации игроков`,
    ...
    description: "Руководство по персонализации системы мониторинга восстановления"
  },
  {
    id: 3,
    title: "Интеграция с планированием тренировок",
    summary: "Как использовать данные о восстановлении для оптимизации тренировочного процесса",
    content: `# Интеграция мониторинга восстановления с планированием тренировок

## Планирование микроциклов (неделя)
...
## Планирование макроциклов (сезон)
...
- Валидация на спортсменах различного уровня`,
    ...
    author: "Спортивный тренер",
    description: "Руководство по интеграции данных восстановления в тренировочный процесс"
  }
]
